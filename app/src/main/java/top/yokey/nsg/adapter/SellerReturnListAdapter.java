...
public class SellerReturnListAdapter extends RecyclerView.Adapter<SellerReturnListAdapter.ViewHolder> {

    private Activity mActivity;
    private NcApplication mApplication;
    private ArrayList<HashMap<String, String>> mArrayList;

    public SellerReturnListAdapter(NcApplication application, Activity activity, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.refundSNTextView.setText("退货编号：");
        ...
        holder.handlerTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mActivity, SellerReturnHandlerActivity.class);
        ...
        holder.detailedTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mActivity, SellerReturnDetailedActivity.class);
                intent.putExtra("refund_id", hashMap.get("refund_id"));
                mApplication.startActivityLoginSuccess(mActivity, intent);
            }
        });
    ...
    public ViewHolder onCreateViewHolder(ViewGroup group, int viewType) {
        View view = LayoutInflater.from(group.getContext()).inflate(R.layout.item_list_seller_return, group, false);
