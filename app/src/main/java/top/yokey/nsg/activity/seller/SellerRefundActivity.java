...
public class SellerRefundActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        refundAdapter = new SellerRefundListAdapter(mApplication, mActivity, refundArrayList);
        ...
        refundBackAdapter = new SellerRefundListAdapter(mApplication, mActivity, refundBackArrayList);
                    ...
                    if (TextUtil.isEmpty(error)) {
                        try {
                            ...
                            if (refundArrayList.isEmpty()) {
                                refundTextView.setText("暂无售前退款订单\n\n一会再来看看吧");
                    ...
                    if (TextUtil.isEmpty(error)) {
                        try {
                            ...
                            if (refundBackArrayList.isEmpty()) {
                                refundBackTextView.setText("暂无售后退款订单\n\n一会再来看看吧");
